...
colors.insert("indogo", atIndex: 5)
//: ### Exercise 4
...
var dic2 = ["Anchovies": true, "Coconut": true, "Cilantro": true, "Liver": false]
...
if let k = presidentialPetsDict["Barack Obama"] {
    print("Michele Obama walks \(k) every morning.")
} else {
    print("Nope")
}
//: ### Exercise 13
